...
// Tips de senior 💡
// Contrairement à Angular qui est un "Framework" complet et rigide, React est juste une "librairie" d'affichage. 
// Il s'en fiche complètement de comment tu vas faire tes appels API ou organiser tes dossiers. C'est sa plus grande force (liberté absolue), mais c'est le premier piège en entreprise : sans une architecture stricte imposée par un Tech Lead, un projet React peut vite devenir incontrôlable.